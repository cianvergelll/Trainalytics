  ...
  <div class="p-6">
    <div class="flex items-center gap-3">
      <div class="relative h-10 w-10 overflow-hidden rounded-full ring-2 ring-purple-100">
        <img src="https://ui-avatars.com/api/?name=Student+User&background=a855f7&color=fff" alt="Profile" />
      </div>
      <div class="flex flex-col">
        <span class="text-sm font-bold text-gray-700 leading-tight">Student Name</span>
  ...
  <nav class="flex-1 px-3 py-2">
    <ul class="space-y-1">
      {#each [
        ...
        { name: 'Complaints', href: '/notifications', icon: 'alert-circle' },
