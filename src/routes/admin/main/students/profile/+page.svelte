					...
					>
						<div class="mb-6 flex items-start justify-between border-b border-gray-100 pb-4">
							<div>
								...
								<p class="mt-0.5 text-xs font-medium text-gray-400">Submitted Requirements</p>
							</div>
						</div>
						...
						<div class="grid grid-cols-1 gap-3 md:grid-cols-2">
							{#each documentList as doc}
								<div
									class="group flex items-center justify-between rounded-lg border border-gray-100 bg-white p-3 transition-all hover:border-blue-200 hover:bg-blue-50/30"
								>
									<div class="flex items-center gap-3 overflow-hidden">
										<div
											class={`flex h-10 w-8 flex-shrink-0 flex-col items-center justify-center rounded text-[9px] font-bold ring-1 ${studentData[doc.key] ? 'bg-blue-50 text-blue-600 ring-blue-100' : 'bg-gray-50 text-gray-400 ring-gray-200'}`}
										>
											PDF
										</div>

										<div class="flex flex-col overflow-hidden">
											<span class="truncate text-sm font-medium text-gray-700" title={doc.name}>
												{doc.name}
											</span>
									...
									<div class="flex items-center gap-2">
										...
										{:else if studentData[doc.key]}
											...
											<a
												...
												download="{doc.name}_{studentData.StudentName || 'Student'}"
												class="flex h-8 w-8 items-center justify-center rounded-md bg-blue-50 text-blue-600 transition-colors hover:bg-blue-100"
												title="Download File"
											>
												<svg
													xmlns="http://www.w3.org/2000/svg"
